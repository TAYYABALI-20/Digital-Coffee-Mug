            ...
            <div className='container'>
                ...
                <div className="tv-container">
                    ...
                    <div
                        className={
                            `
                                ${isTvOff && !isPlayButtonClick ? "television open bg-change" : "television off"}
                            `
                        }
                    >
                        ...
                        <div className={isTvOff ? "television-rightIn light-on" : "television-rightIn light-off"} />
                ...
                <div className={isMobileButtonClick ? "tv-remote-container expand remote-z-index" : "tv-remote-container"}>

                    <div
                        className={isTvOff ? 'remote-indicator on' : 'remote-indicator off'}
                    />
